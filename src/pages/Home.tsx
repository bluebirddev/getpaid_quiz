          ...
          <div className="max-w-[300px] mx-6 w-full text-body flex flex-col flex-1">
            ...
            <ol className="space-y-6 mt-8 mb-[60px] text-black text-sm leading-[17px]">
              ...
              <li className="flex items-center gap-x-2.5">
                ...
                In order to qualify for the voucher, you must listen to the agent’s competitive
                quote.
              </li>
              <li className="flex items-center gap-x-2.5">
                <div>
                ...
                We will send your voucher via SMS, two working days after you received the call.
              </li>
            </ol>

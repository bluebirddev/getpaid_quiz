...
export const questions: Question[] = [
    ...
    },
    {
        ...
        label: "Can we call you about Life Insurance offers? (You'll get paid if you get a quote, of course)",
        required: true,
    ...
    },
    {
        ...
        description: (
            <>
                I provide consent to have my personal information collected, processed, and possibly
                shared with third parties who may contact me based on my profile with the hope to
                make a sale. The sharing of this information with third parties will allow me to
                earn a financial reward.
                <br />
                <br />
    ...
    },
    {
        ...
        description: (
            <>
                I understand that I am under no obligation to buy any product, or take up any
                service when I’m contacted by a third-party marketer
            </>
        ),
        type: 'agree-disagree',
        validate: (value) => (!value ? 'You must agree to the terms to continue' : undefined),
